...
//Onde as collections são instanciadas da model
...
rota.get("/categorias", (req, res) => {
  ...
  Categoria.find().sort({ date: 'desc' }).then((categorias) => {
    res.render("controller/controllerCategoria/categorias", { categorias: categorias });
  }).catch((err) => {
...
rota.get('/categorias/add', (req, res) => {
  res.render("controller/controllerCategoria/addcategorias");
});
...
rota.post("/categorias/nova", (req, res) => {
  var erros = []
    ...
    new Categoria(novaCategoria).save().then(() => {
      ...
      res.redirect("/controller/controllerCategoria/categorias");
    }).catch((err) => {
...
rota.get("/categorias/edit/:id", (req, res) => {
  ...
  Categoria.findOne({ _id: req.params.id }).then((categoria) => {
    ...
    res.render("controller/controllerCategoria/editcategorias", { categoria: categoria });
...
rota.get("/postagens", (req, res) => {
  Postagem.find().populate("categoria").sort({ data: "desc" }).then((postagens) => {
    res.render("controller/controllerPostagem/postagens", { postagens: postagens });
  }).catch((err) => {
    req.flash("error_msg", "Houve um erro ao listar as postagens");
    res.redirect("/controller/controllerPostagem/postagens");
  });
});
...
rota.get("/postagens/add", (req, res) => {
  Categoria.find().then((categorias) => {
    res.render("cotroller/controllerPostagem/addpostagem", { categorias: categorias });
  }).catch((err) => {
...
rota.get("/postagens/edit/:id", (req, res) => {
  Postagem.findOne({ _id: req.params.id }).then((postagem) => {
    Categoria.find().then((categorias) => {
      res.render("controller/controllerPostagem/editpostagens", { categorias: categorias, postagem: postagem });
    }).catch((err) => {
      req.flash("error_msg", "Houve um erro ao listar as categorias");
      res.redirect("/controller/controllerPostagem/postagens");
    });
...
rota.get('/pontocoleta/add', (req, res) => {
  Categoria.find().then((categorias) => {
  res.render("controller/controllerPonto/addpontocoleta",{categorias: categorias});
}).catch((err) => {
    req.flash("error_msg", "Houve um erro ao listar os pontos de coleta");
    res.redirect("/controller/controllerPonto/pontocoleta");
  });
});
...
rota.get("/pontocoleta", (req, res) => {
  ...
  PontoColeta.find().populate("categoria").sort({ data: "desc" }).then((pontocoleta) => {
    res.render("controller/controllerPonto/pontocoleta", { pontocoleta: pontocoleta });
  }).catch((err) => {
    req.flash("error_msg", "Houve um erro ao listar as categorias");
    res.redirect("/controller/controllerPonto/pontocoleta");
  });
...
rota.get("/ponto-coleta/edit/:id", (req, res) => {
  PontoColeta.findOne({ _id: req.params.id }).then((pontocoleta) => {
      Categoria.find().then((categorias) => { 
    //categoria eh um objeto que pode ser usado na view
    res.render("controller/controllerPonto/editpontocoleta", {categorias: categorias, pontocoleta: pontocoleta });
  }).catch((err) => {
      req.flash("error_msg", "Houve um erro ao listar as categorias");
      res.redirect("/controller/controllerPonto/pontocoleta");
    });
...
rota.post("/ponto-coleta/edit", (req, res) => {
  PontoColeta.findOne({ _id: req.body.id }).then((pontocoleta) => {
    ...
    req.flash(("error_msg", "Houve um erro ao editar a categoria"));
    res.redirect("/controller/controllerPonton/pontocoleta");
  });
});
